...
(custom-set-variables
 ...
 '(helm-ff-skip-boring-files t nil nil "change to show hidden files --eric")
...
(custom-set-faces
 ...
 '(helm-ff-directory ((t (:foreground "#586e75" :weight ultra-bold))))
 ...
 '(match ((t (:background "RoyalBlue3" :foreground "#0a2832"))))
